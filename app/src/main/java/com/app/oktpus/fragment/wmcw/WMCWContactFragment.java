...
import com.app.oktpus.model.wmcw.WMCWContactModel;
...
public class WMCWContactFragment extends Fragment {
    ...
    public WMCWContactFragment() {}

    public static WMCWContactFragment create(String key) {
        Bundle args = new Bundle();
        args.putString(ARG_KEY, key);

        WMCWContactFragment fragment = new WMCWContactFragment();
    ...
    public void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        WMCWContactModel model = (WMCWContactModel) mPage;
