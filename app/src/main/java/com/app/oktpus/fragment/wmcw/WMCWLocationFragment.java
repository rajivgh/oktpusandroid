...
import com.app.oktpus.model.wmcw.WMCWLocationModel;
...
public class WMCWLocationFragment extends Fragment {
    ...
    public WMCWLocationFragment() {}

    public static WMCWLocationFragment create(String key) {
        Bundle args = new Bundle();
        args.putString(ARG_KEY, key);

        WMCWLocationFragment fragment = new WMCWLocationFragment();
    ...
    public void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        WMCWLocationModel model = (WMCWLocationModel) mPage;
    ...
    @Override
    public void onPause() {
        super.onPause();mPage.notifyDataChanged();
    }
}
