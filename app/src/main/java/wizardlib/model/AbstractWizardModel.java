...
/**
 * Represents a wizard wizardlib.model, including the pages/steps in the wizard, their dependencies, and their
 * currently populated choices/values/selections.
 *
 * To create an actual wizard wizardlib.model, extend this class and implement {@link #onNewRootPageList()}.
 */
public abstract class AbstractWizardModel implements ModelCallbacks {
    ...
    /**
     * Override this to define a new wizard wizardlib.model.
     */
    ...
    public void load(Bundle savedValues) {
        for (String key : savedValues.keySet()) {
            ...
            //mRootPageList.findByKey(key).resetSavedData(savedValues.getBundle(key));
        }
    }
